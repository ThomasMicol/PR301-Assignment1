class Person(object):
    ...
    def __str__(self):
        string = u'[<Person> emp_id:%s gender:%s age:%s sales:%s bmi:%s salary:%s birthday:%s]' %(self.emp_id,self.gender,self.age,self.sales,self.bmi,self.salary,self.birthday)
        return string
